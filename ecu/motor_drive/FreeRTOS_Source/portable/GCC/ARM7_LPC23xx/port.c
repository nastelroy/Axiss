...
unsigned portLONG ulCompareMatch;
	...
	#if (TIMER0_TERUS == 1)
		T0PR = 3 - 1;	// set the prescale divider (60 / 3, 20 Mhz (50 ns))
		ulCompareMatch = (configCPU_CLOCK_HZ / (configTICK_RATE_HZ * 3));		
	#else
	...
	#if (TIMER0_TERUS == 1)
	timer0_increment = ulCompareMatch;
	T0MCR = BIT(3);
	#else
